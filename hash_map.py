# Logan Cope
# Description: Implements Hash Map data structure built utilizing a linked list and dynamic array classes
...
class HashMap:
    ...
    def clear(self) -> None:
        """
        Clears contents of hash map without changing underlying capacity
        """
        # set each bucket to an empty list
    ...
    def get(self, key: str) -> object:
        """
        Returns the value associated with the given key. If the key is not in the hash map, the
        method returns None.
        """
        ...
        # iterate over linked list, if we find the key, return its value
    ...
    def put(self, key: str, value: object) -> None:
        ...
        # get LinkedList that corresponds to given key
        linked_list = self.buckets.get_at_index(index)
    ...
    def contains_key(self, key: str) -> bool:
        """
        Returns True if given key is in hash map and False otherwise
        """
        # use hash_function to get position of index
        index = self.hash_function(key) % self.capacity
        ...
        # iterate over linked list, if we find the key, return True
        iterable = linked_list.__iter__()
        for element in iterable:
            if element.key == key:
                return True
    ...
    def empty_buckets(self) -> int:
        ...
        """
        # initialize empty bucket number to 0
        empty_buckets = 0
        for i in range(self.capacity):
    ...
    def resize_table(self, new_capacity: int) -> None:
        ...
        # fill new hash map with the existing key/value pairs
        for i in range(self.capacity):
        ...
        # set capacity and buckets to new HashMap's capacity/buckets
        self.capacity = new_capacity
        self.buckets = new_hash_map.buckets

    def get_keys(self) -> DynamicArray:
        """
        Returns a DynamicArray of all keys stored in hash map
        """
        # create DynamicArray to store keys
        keys = DynamicArray()

        # iterate through hash map and add keys to the keys DynamicArray
        for i in range(self.capacity):
            linked_list = self.buckets.get_at_index(i)
            iterable = linked_list.__iter__()
            for element in iterable:
